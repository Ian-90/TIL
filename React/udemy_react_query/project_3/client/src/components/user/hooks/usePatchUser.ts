  ...
  const { mutate: patchUser } = useMutation(
    (newUserData: User) => patchUserOnServer(newUserData, user),
    {
      ...
      onMutate: async (newData: User | null) => {
        ...
        // dosesn't overwrite our optimistic update
      ...
      onError: (error, newData, previousUserDateContext) => {
        // rollback cache to saved value
        if (previousUserDateContext.previousUserData) {
          updateUser(previousUserDateContext.previousUserData);
          toast({
